...
def main():
    ...
    file_path = "results/ickg/ablation-gpt-4o-mini-2025_04_08-13_49_22-benchmark_format-with_results.json"
    
    # Load the data
    ablation_data = load_ablation_data(file_path)
    
    # Create visualizations
    visualize_ablation_study(ablation_data, "ickg_ablation_study.png")
    # visualize_query_impacts(ablation_data, "ickg_query_impacts.png")
